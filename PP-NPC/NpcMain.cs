...
namespace PPnpc
{
	public class NpcMain
	{
		...
		public static Sprite[] eSprites, iSprites, uSprites;
		...
		public static void Main()
		{
			...
			ModAPI.Register(new Modification()
			{
				...
				AfterSpawn					= (Instance) =>
				{
					...
					rebirther.SetupRebirther();

					Instance.FixColliders();
					xxx.ToggleCollisions(expansion.transform, Instance.transform,false,false);
