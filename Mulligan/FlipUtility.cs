...
namespace Mulligan
{
	...
	public class FlipUtility
	{
		...
		public static void FlipInit(PhysicalBehaviour[] PBs)
		{
			...
			switch ( FlipState )
			{
				...
				case FlipStates.postflip:
					...
					if (Mulligan.verboseLevel >= 2) ModAPI.Notify(
						"<color=blue><-></color> "
						+ "<color=red>Items: "    + FlipCounts.Items   + "</color> "
						+ "<color=green>Cars: "   + FlipCounts.Cars    + "</color> "
						+ "<color=yellow>Peeps: " + FlipCounts.People  + "</color> ");
